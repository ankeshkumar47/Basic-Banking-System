...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:#1362d8;font-family: 'Courgette', cursive;font-size:2.2em;padding:3%;">Transfer Record</h3>
    <table id="myTable">
          <tr>
            <th>Transfer ID</th>
            <th>Sender</th>
...
<!-- Footer -->
<div class="footer">
   <span style="font-family:verdana;">&copy;</span> 2021 Sparks Bank | Maintained and Developed by Ankesh
</div>
</body>
